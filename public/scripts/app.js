...
var Traveler = function (_Person2) {
  ...
  function Traveler(name, age) {
    var homeLocation = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
  ...
  _createClass(Traveler, [{
    ...
    value: function getGreeting() {
      ...
      return this.homeLocation ? description += " I am visiting from " + this.homeLocation : description;
    }
  }]);
...
var student = new Student("Ryan", 36, "Computer Science");
console.log(student.getGreeting());

var traveler = new Traveler("FOB", 27, "Troy");
